...
def index(request):
    try:
        ...
        user_get_api = setting.user_get_api
        if user_get_api == 1:
...
def tablestoday(request, date):
    try:
        ...
        return render(request,"tablestoday.html",{"date":"","date_bf":"",
        "date_af":"","date_th":"","date_bf_th":"",
        "date_af_th":"","league1":[], "data": [],"league_id":[]})
