"""
Django settings for footballresults_django project.
...
SECRET_KEY = 'django-insecure-+&vt7a)96zc(t(2^xb@%b5xas%@(fu_-!-cq&$qkr)!h7d_)u6'
...
ROOT_URLCONF = 'footballresults_django.urls'
...
WSGI_APPLICATION = 'footballresults_django.wsgi.application'
